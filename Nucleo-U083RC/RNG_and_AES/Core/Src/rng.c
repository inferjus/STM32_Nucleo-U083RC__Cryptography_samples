...
volatile RngMode_enum currentRngMode = RNG_MODE_IDLE;
	    ...
	    if (currentRngMode == RNG_MODE_IV) {
	        ...
	        if (freshIv.generatingStage<sizeof(pInitVectAES)) {
	            ...
	            if (freshIv.generatingStage < sizeof(pInitVectAES)) {
	            	...
	            	freshIv.ready=1;
	                currentRngMode = RNG_MODE_IDLE;
	            }
	        }
	    }
		//seed
	    else if (currentRngMode == RNG_MODE_SEED) {
